...
export default GameScreens = ({route, navigation}) => {
    ...
    const renderStars = () => {
          ...
          for (let s = 1; s <= 5; s++){
            ...
            stars.push(
            <Ionicons key={s} name='ios-star' size={16} style={{marginRight: 5 }} color={Math.floor(game.rating) >= s ? "#819ee5" : "#434958"}/>)
  ...
  return (
      ...
      <GameStatsContainer>
               ...
               <Text blod color="#9a9a9a">{game.category[0]}</Text>
               <Text blod color="#9a9a9a">{game.age}</Text>
               <Text blod color="#9a9a9a" >Game of the day</Text>
